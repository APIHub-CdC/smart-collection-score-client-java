# smart-collection-score-client-java [![GitHub Packages](https://img.shields.io/badge/Maven&nbsp;package-Last&nbsp;version-lemon)](https://github.com/orgs/APIHub-CdC/packages?repo_name=smart-collection-score-client-java) 
...
En el archivo SmartCollectionScoreApiTest.java, que se encuentra en ***src/test/java/io/SmartCollectionScore/client/api/***. Se deberá modificar los datos de la petición y los datos de consumo:
